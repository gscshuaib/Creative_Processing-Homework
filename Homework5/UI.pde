void UI() {
  ...
  bar.addSlider("heightSection", 10, 500, 100, canvasLeftCornerX+barSize+50, canvasLeftCornerY , barSize, barHeight).setLabel("高度细分系数");
  
  bar.addSlider("kMin", 0, heightSection, 30, canvasLeftCornerX+barSize+50, canvasLeftCornerY + barInterval, barSize, barHeight).setLabel("kMin");
  bar.addSlider("kMax", 0, heightSection, heightSection-30, canvasLeftCornerX+barSize+50, canvasLeftCornerY + barInterval * 2, barSize, barHeight).setLabel("kMax");
